...
public enum EnumNoteExcel {
    ...
    EnumNoteExcel(String id, String name) {
        this.id = id;
        this.name = name;
    ...
    private static class Holder {
        static Map<String, EnumNoteExcel> map = new HashMap<>();
    }

    public static EnumNoteExcel find(String id) {
        return Holder.map.get(id);
    }

    public static String getValueByKey(String key) {
        Optional<EnumNoteExcel> tier = Arrays.stream(EnumNoteExcel.values())
    ...
    public static String getKeyByValue(String value) {
        Optional<EnumNoteExcel> tier = Arrays.stream(EnumNoteExcel.values())
            ...
            .findFirst();
        return tier.map(EnumNoteExcel::getId).orElse(null);
    }
}
