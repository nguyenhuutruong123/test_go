 ...
 */
@Entity
@Table(name = "proforma_invoice_detail_log")
public class ProformaInvoiceDetailLog implements Serializable {
    ...
    @JsonIgnore
    @JoinColumn(name = "proforma_invoice_detail_id", referencedColumnName = "id")
    private ProformaInvoiceDetail proformaInvoiceDetail;
    ...
    public void setProformaInvoiceDetail(ProformaInvoiceDetail proformaInvoiceDetail) {
        this.proformaInvoiceDetail = proformaInvoiceDetail;
    }

    public ProformaInvoiceDetail getProformaInvoiceDetail() {
        return proformaInvoiceDetail;
    }

    public ProformaInvoiceDetailLog proformaInvoiceDetail(ProformaInvoiceDetail proformaInvoiceDetail) {
        this.setProformaInvoiceDetail(proformaInvoiceDetail);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProformaInvoiceDetailLog)) {
            return false;
        }
        return id != null && id.equals(((ProformaInvoiceDetailLog) o).id);
    }
