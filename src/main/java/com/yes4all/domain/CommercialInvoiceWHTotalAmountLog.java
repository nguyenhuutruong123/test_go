 ...
 */
@Entity
@Table(name = "commercial_invoice_wh_total_amount_log")
public class CommercialInvoiceWHTotalAmountLog implements Serializable {
    ...
    public CommercialInvoiceWHTotalAmountLog commercialInvoiceWH(CommercialInvoiceWH commercialInvoice) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommercialInvoiceWHTotalAmountLog)) {
            return false;
        }
        return id != null && id.equals(((CommercialInvoiceWHTotalAmountLog) o).id);
    }
